        ...
        <div class="h-[64px]">
          <div class="px-4 h-[64px] flex fixed z-10 items-center justify-between border-b-[1px]" :style="{ width: `${store.sidebarExpanded ? 280 : 64}px` }">
            <transition name="fade">
              <h2 v-show="store.sidebarExpanded" class="text-2xl gap-2 font-semibold flex items-center">
                <img
              :src="LogoImage"
              alt="Logo"
              class="inset-0 h-5 w-5 object-contain dark:brightness-[0.2] dark:grayscale"
                />
                WATCH Portal
              </h2>
            </transition>
